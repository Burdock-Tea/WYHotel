    ...
    <section>
	    <div class="container">
	        <div class="row">
			    ...
			    <h2 class="pt-5 pb-2">HOTEL STORY</h2>
		        <img class="img-fluid" src="${pageContext.request.contextPath}/img/ship-gc57a68d8a_1920.jpg" alt="메인 이미지">
	            <!-- 1번 이미지 -->
	            <h3 class="mt-5 mb-4">SIGNATURE EXPERIENCE</h3>
	            <p class="mb-4">
				...
				<!-- 2번 이미지 -->
                <img class="introImg1 mt-4 mb-2" src="${pageContext.request.contextPath}/img/hotel-g89d6d2350_1920.jpg" alt="img1">
	            <div class="col-12 pb-5">
	                <div class="col-12 justify-content-end">
	                    <img class="introImg1 float-end" src="${pageContext.request.contextPath}/img/hotel-g778b6dc8d_1920.jpg" alt="img2">
	                    <div class="col-5 mt-5">
	                        <h3 class="mb-3">HOTEL STORY</h3>
	                        <p class="intrFont">
