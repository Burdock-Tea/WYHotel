            ...
            <div class="col-9">
                ...
                <div class="row">
                    ...
                    <div class="col-3" id="customerEdit">
                        <!-- 수정 버튼 -->
                        <a href="${bno}" class="badge rounded-pill bg-dark" data-bs-toggle="modifiy-modal" data-bs-target="#modifyModal" data-title="수정" data-footer="수정하시겠습니까?"> 수정 </a>

  

                        <!-- 삭제 버튼 -->
                        <a href="${bno}" class="badge rounded-pill bg-dark" data-bs-toggle="del-modal" data-bs-target="#delModal" data-title="삭제" data-footer="삭제하시겠습니까?"> 삭제 </a>
