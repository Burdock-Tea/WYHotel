    ...
    <div class="row">
        ...
        <div class="loginDiv">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item col-lg-6 col-md-6 col-sm-6 col-6 check-login" role="presentation">
                    <button class="nav-link active col-lg-12 col-md-12 col-sm-12 col-12 check-btn" id="home-tab"
                        data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab"
                        aria-controls="home-tab-pane" aria-selected="true">회원 로그인</button>
                </li>
                <li class="nav-item col-lg-6 col-md-6 col-sm-6 col-6 check-login" role="presentation">
                    <button class="nav-link col-lg-12 col-md-12 col-sm-12 col-12 check-btn" id="profile-tab"
                        data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab"
                        aria-controls="profile-tab-pane" aria-selected="false">비회원 예약</button>
                </li>
            </ul>
        </div>
        ...
        <div class="tab-content col-lg-4 login-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                ...
                <!-- 회원 로그인 -->
                <div>
                    <form id="login-form" action="${pageContext.request.contextPath}/reservation/login" method="post">
                        <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="flexCheckDefault" name="rememberId">
                        ...
                        <div class="d-grid gap-2 login-btn">
                            <button type="button" id="loginBtn" class="btn btn-dark userLogin-btn">
                                <font style="vertical-align: inherit;">
                                    <font style="vertical-align: inherit;">로그인</font>
                                </font>
                            </button>
                            <button type="button" id="joinBtn" class="btn btn-secondary userLogin-btn">
                                <font style="vertical-align: inherit;">
